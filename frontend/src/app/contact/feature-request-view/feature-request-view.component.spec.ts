...
import { FeatureRequestViewComponent } from './feature-request-view.component';
...
describe('BugReportViewComponent', () => {
  let component: FeatureRequestViewComponent;
  let fixture: ComponentFixture<FeatureRequestViewComponent>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [FeatureRequestViewComponent],
    ...
    fixture = TestBed.createComponent(FeatureRequestViewComponent);
  ...
  it('should handle form submission successfully', fakeAsync(() => {
    ...
    component.values = mockRequest as FormValuesFeature;
    ...
    expect(mockSnackBar.open).toHaveBeenCalledWith(
      `Der Feature Request wurde erfolgreich abgesendet`,
    );
  }));
